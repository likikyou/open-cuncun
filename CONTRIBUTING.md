...
3. Make your changes
4. Run tests: `python scripts/verify.py --offline && python -m pytest tests`
5. Run linting: `python -m ruff check app scripts tests`
6. Run the public-release audit: `python scripts/oss_release_audit.py`
...
- Follow PEP 8
- Use Ruff for linting: `python -m ruff check app scripts tests`
