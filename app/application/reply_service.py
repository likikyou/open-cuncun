...
def generate_reply(
    ...
    *,
    ...
    reply_mode = (
        ...
        else get_user_setting_fn(open_id, "reply_mode", "normal")
    )
    ...
    if direct_current_time_reply:
        ...
        summary_info = {"intent": "报当前时间", "emotion": "平静", "theme": "日常"}
        logger_obj.info(
    ...
    summary_info = None
    ai_iterator = call_ai_stream_fn(
        prompt, user_text, history, reply_mode=reply_mode, user_id=open_id
    )
