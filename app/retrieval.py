...
def get_user_profile_memory(
    ...
    return _format_memory_block("关于用户的稳定印象", docs)
...
try:
    ...
    # 3. 新机器拉代码后，如果要恢复 persona/user_profile/relationship 分层，
    #    需要先准备本地 MEMORY_PATH，再运行部署方维护的仓外迁移管道。
