...
| 中文口语思念纠偏 | 像“想死你了”“想你想死了”这类高频口语会识别为非字面的夸张思念；具体语气和关系由部署者的人格配置与上下文决定 |
...
- [OPEN_SOURCE_ROADMAP.md](OPEN_SOURCE_ROADMAP.md)：公开主线、仓库拆分、私有部署边界与发布规则
- [CORE_API_V1.md](CORE_API_V1.md)：Console 与语音客户端共用的 Core API v1 契约
...
- 改对外接口，同步 `CORE_API_V1.md`
- 从私有部署迁移通用能力时，先通过 `python scripts/oss_release_audit.py`
