...
- `scripts/verify.py --offline` 显示全部检查通过
...
DB_PATH=/tmp/companion_restore_test.db MEMORY_PATH=/tmp/companion_restore_memory python scripts/verify.py --offline
```
